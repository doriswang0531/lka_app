...
### --- LOAD DATASET
os.chdir(r'C:\Users\wb450887\OneDrive - WBG\Documents\ArcGIS\Projects\Sri Lanka\Tank')
...
tank_df = pd.read_csv(tank_csv_file, encoding='utf-8')
...
image1 = Image.open('tank_irri.jpg')
image2 = Image.open('tank_agri.jpg')
image3 = Image.open('tank_agri_day.jpg')
...
dist_df = pd.read_csv(r'C:\Users\wb450887\OneDrive - WBG\Documents\ArcGIS\Projects\Sri Lanka\Tank\UNDP_small_tanks_merged_dist.csv', encoding='utf-8')
...
dist_poverty_df = pd.read_csv('HIES_poverty_agri.csv')
...
image4 = Image.open('dist_pop_agri.jpg')
image5 = Image.open('dist_pop_func.jpg')
...
asc_df = pd.read_csv('UNDP_small_tanks_merged_asc.csv', encoding='utf-8')
...
asc_pov_df = pd.read_csv('HIES_poverty_asc.csv', encoding='utf-8')
...
image7 = Image.open('asc_pop_se_dro.jpg')
